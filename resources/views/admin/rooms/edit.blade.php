            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-[#7a6a58]
                        ...
                        Update and manage room facility information.
            ...
            <form method="POST"
                ...
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <div class="col-span-6">
                        ...
                        <input type="text"
                               name="room_id"
                               value="{{ old('room_id', $room->room_id) }}"
                    ...
                    <div class="col-span-6">
                        ...
                        <select name="room_type"
                            ...
                            <option value="Meeting Room"
                                {{ $room->room_type == 'Meeting Room' ? 'selected' : '' }}>
